...
This version of ockhamSEM includes alternative graph and table outputs. The figures shown below are part of the original ockhamSEM package, not the new ones.
